...
class AddClock extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(59:5)", "entry");
            Column.padding(20);
            Column.backgroundColor('#fff');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(60:7)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create('/images/cuo.png');
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(61:9)", "entry");
            Image.width(28);
            Image.onClick(() => {
                router.back();
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(65:9)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('添加闹钟');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(66:11)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(67:11)", "entry");
            Text.fontSize(14);
        }, Text);
        Text.pop();
        Column.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(69:9)", "entry");
            Image.width(28);
            Image.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TimePicker.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(116:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(131:7)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(132:9)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.width('100%');
            Row.padding({ left: 10 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('铃声');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(133:11)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(134:11)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('元素动态铃声');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(135:13)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(136:13)", "entry");
            Image.width(16);
        }, Image);
        Row.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(139:9)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.width('100%');
            Row.padding({ left: 10 });
            Row.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('重复');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(140:11)", "entry");
            Text.fontSize(18);
            Text.fontWeight(FontWeight.Medium);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(141:11)", "entry");
            Row.layoutWeight(1);
            Row.justifyContent(FlexAlign.End);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.repeat);
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(142:13)", "entry");
            Text.fontSize(16);
            Text.fontColor('#aaaaaa');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create('/images/next.png');
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(144:13)", "entry");
            Image.width(16);
        }, Image);
        Row.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(152:9)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.width('100%');
            Row.padding({ left: 10 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('响铃时震动');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(153:11)", "entry");
            Text.fontSize(18);
            Text.fontWeight(FontWeight.Medium);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(154:11)", "entry");
        }, Toggle);
        Toggle.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(159:9)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.width('100%');
            Row.padding({ left: 10 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(160:11)", "entry");
            Text.fontSize(18);
            Text.fontWeight(FontWeight.Medium);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(161:11)", "entry");
        }, Toggle);
        Toggle.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(166:9)", "entry");
            Row.height(50);
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('标题');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(167:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(169:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(174:9)", "entry");
            Row.height(50);
            Row.width('100%');
            Row.backgroundColor('#efefef');
            Row.borderRadius(10);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('备注');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(175:11)", "entry");
            Text.padding({ left: 10 });
            Text.fontSize(18);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AddClock.ets(177:11)", "entry");
            TextInput.layoutWeight(1);
            TextInput.backgroundColor(Color.Transparent);
            TextInput.fontSize(16);
        }, TextInput);
