...
class Index1_2024_11_13 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            RelativeContainer.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index1_2024_11_13.ets(26:5)", "entry");
            RelativeContainer.height('100%');
            RelativeContainer.width('100%');
        }, RelativeContainer);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.message);
            Text.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index1_2024_11_13.ets(27:7)", "entry");
