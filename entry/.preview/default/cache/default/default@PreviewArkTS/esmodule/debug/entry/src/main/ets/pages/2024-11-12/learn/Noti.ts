...
class Noti extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/Noti.ets(57:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('发送普通通知');
            Button.debugLine("entry/src/main/ets/pages/2024-11-12/learn/Noti.ets(58:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-12/learn/Noti.ets(74:7)", "entry");
            Button.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-12/learn/Noti.ets(94:7)", "entry");
            Button.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-12/learn/Noti.ets(113:7)", "entry");
            Button.onClick(async () => {
