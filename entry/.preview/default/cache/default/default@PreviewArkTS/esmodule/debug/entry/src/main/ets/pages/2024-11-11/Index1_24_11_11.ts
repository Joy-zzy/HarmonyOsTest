...
class Index1_24_11_11 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-11/Index1_24_11_11.ets(15:5)", "entry");
            Column.width('100%');
            Column.alignItems(HorizontalAlign.Center);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("msg:" + this.msg);
            Text.debugLine("entry/src/main/ets/pages/2024-11-11/Index1_24_11_11.ets(16:7)", "entry");
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('存储');
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/Index1_24_11_11.ets(17:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/Index1_24_11_11.ets(21:7)", "entry");
            Button.onClick(async () => {
                this.msg = await this.store.getData('data');
            });
        }, Button);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/Index1_24_11_11.ets(25:7)", "entry");
            Button.onClick(async () => {
                router.pushUrl({
