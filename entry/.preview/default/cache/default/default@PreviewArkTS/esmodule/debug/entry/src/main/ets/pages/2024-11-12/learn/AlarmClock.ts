...
class AlarmClock extends ViewPU {
    ...
    listEnd(alarm: RemiInfo, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(76:5)", "entry");
            Image.width(32);
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(83:5)", "entry");
            Stack.height('100%');
            Stack.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(84:7)", "entry");
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('闹钟');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(85:9)", "entry");
            Text.fontSize(22);
            Text.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(86:9)", "entry");
        }, List);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
            const forEachItemGenFunction = _item => {
                const alarm = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(88:13)", "entry");
                    };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(98:7)", "entry");
            Image.width(30);
            Image.height(30);
...
class ClockItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(116:5)", "entry");
            Row.width('100%');
            Row.height(80);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(117:7)", "entry");
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create();
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(118:9)", "entry");
        }, Text);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Span.create((this.clock.hour - (this.clock.hour > 12 ? 12 : 0)).toString().padStart(2, '0') + ":" + this.clock.minute.toString().padStart(2, '0'));
            Span.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(119:11)", "entry");
            Span.fontSize(22);
            Span.fontWeight(FontWeight.Bold);
        }, Span);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Span.create(this.clock.hour > 12 ? '下午' : '上午');
            Span.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(121:11)", "entry");
            Span.fontSize(14);
            Span.fontColor('gray');
        }, Span);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ImageSpan.create('');
            ImageSpan.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(122:11)", "entry");
            ImageSpan.margin({ left: 10 });
        }, ImageSpan);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Span.create(this.clock.title);
            Span.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(123:11)", "entry");
            Span.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(125:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(128:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({
            ...
            Toggle.debugLine("entry/src/main/ets/pages/2024-11-12/learn/AlarmClock.ets(129:7)", "entry");
