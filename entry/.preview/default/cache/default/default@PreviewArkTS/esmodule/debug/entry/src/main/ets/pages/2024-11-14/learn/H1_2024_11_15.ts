...
class H1_2024_11_15 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-14/learn/H1_2024_11_15.ets(14:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('display属性');
            Button.debugLine("entry/src/main/ets/pages/2024-11-14/learn/H1_2024_11_15.ets(15:7)", "entry");
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-14/learn/H1_2024_11_15.ets(19:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-14/learn/H1_2024_11_15.ets(24:7)", "entry");
            Button.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-14/learn/H1_2024_11_15.ets(28:7)", "entry");
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-14/learn/H1_2024_11_15.ets(32:7)", "entry");
            Button.onClick(() => {
