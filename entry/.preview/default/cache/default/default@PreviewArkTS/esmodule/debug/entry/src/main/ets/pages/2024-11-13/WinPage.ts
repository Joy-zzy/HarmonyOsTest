...
class WinPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-13/WinPage.ets(103:5)", "entry");
            Column.width('100%');
            Column.height("100%");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/WinPage.ets(105:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/WinPage.ets(111:7)", "entry");
            Button.onClick(async () => {
                try {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/WinPage.ets(125:7)", "entry");
            Button.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-13/WinPage.ets(130:7)", "entry");
            Image.width(200);
        }, Image);
        Column.pop();
    }
