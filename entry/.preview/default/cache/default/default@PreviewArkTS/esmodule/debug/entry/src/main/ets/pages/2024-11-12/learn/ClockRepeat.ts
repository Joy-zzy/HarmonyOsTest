...
class ClockRepeat extends ViewPU {
    ...
    zhou(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(33:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(34:7)", "entry");
            Column.height(70);
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('自定义');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(35:9)", "entry");
            Text.fontSize(18);
        }, Text);
        Text.pop();
        Column.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(38:9)", "entry");
                    Column.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(39:11)", "entry");
                    Row.height('100%');
                    Row.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(week);
                    Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(40:13)", "entry");
                    Text.fontSize(18);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Radio.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(41:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(52:7)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(53:9)", "entry");
            Button.width('48%');
            Button.height(50);
            Button.fontSize(20);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(60:9)", "entry");
            Button.width('48%');
            Button.height(50);
            Button.fontSize(20);
            Button.onClick(() => {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(85:5)", "entry");
            Column.height('100%');
            Column.width('100%');
            Column.padding(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(86:7)", "entry");
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(87:9)", "entry");
            Image.width(32);
            Image.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('重复');
            Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(92:9)", "entry");
            Text.fontSize(20);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create('/images/dui.png');
            Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(93:9)", "entry");
            Image.width(32);
            Image.onClick(() => {
                this.days = [...this.coD];
                router.back();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(100:9)", "entry");
                    Row.width('100%');
                    Row.height(50);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(101:11)", "entry");
                    Image.width(20);
                    Image.visibility(index == this.selected ? Visibility.Visible : Visibility.Hidden);
                }, Image);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(type);
                    Text.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(102:11)", "entry");
                    Text.fontSize(18);
                    Text.margin({ left: 10 });
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(104:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    If.create();
                    if (index == this.types.length - 1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Image.debugLine("entry/src/main/ets/pages/2024-11-12/learn/ClockRepeat.ets(106:13)", "entry");
                                Image.width(16);
                            }, Image);
                        });
                    }
