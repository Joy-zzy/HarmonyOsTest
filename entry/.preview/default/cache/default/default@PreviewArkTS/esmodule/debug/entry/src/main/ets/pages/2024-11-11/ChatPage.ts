...
class ChatPage extends ViewPU {
    ...
    async sendMessageFn() {
        ...
        if (resData.result == 0) {
            ...
            let conObj: chatClass = {
                content: content,
                avatar: { "id": 16777216, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" },
                id: util.generateRandomUUID(),
                selfFlag: false
            };
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(75:5)", "entry");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("老王");
            Text.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(76:7)", "entry");
            Text.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(82:7)", "entry");
            List.width("100%");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.width("100%");
                        ListItem.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(86:11)", "entry");
                    };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(100:7)", "entry");
            Row.height(50);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({
            ...
            TextInput.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(101:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(108:9)", "entry");
            Button.onClick(() => {
                this.sendMessageFn();
            });
        }, Button);
...
class ChatItemCom extends ViewPU {
    ...
    popupBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('删除');
            Text.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(128:5)", "entry");
            Text.height(30);
            Text.textAlign(TextAlign.Center);
            Text.width(100);
            Text.onClick(() => {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(139:5)", "entry");
            Row.height(40);
            Row.width("100%");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(141:7)", "entry");
            Image.width(50);
            Image.margin({
                left: 10,
                right: 10
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/2024-11-11/ChatPage.ets(147:7)", "entry");
