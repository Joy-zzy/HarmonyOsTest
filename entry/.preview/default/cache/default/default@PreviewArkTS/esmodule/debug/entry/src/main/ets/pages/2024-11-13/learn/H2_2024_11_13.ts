...
class H2_2024_11_13 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(33:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(38:9)", "entry");
                    Column.width('48%');
                    Column.margin({ bottom: 10 });
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create(order.ava);
                    Image.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(39:11)", "entry");
                    Image.width('100%');
                }, Image);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(order.title);
                    Text.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(40:11)", "entry");
                    Text.fontSize(16);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(41:11)", "entry");
                    Row.width('100%');
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(order.time + "开播");
                    Text.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(42:13)", "entry");
                    Text.fontSize(12);
                    Text.fontColor('blue');
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(43:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(44:13)", "entry");
                    Row.onClick(async () => {
                        if (!order.ordered) {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(45:15)", "entry");
                    Text.fontSize(13);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("entry/src/main/ets/pages/2024-11-13/learn/H2_2024_11_13.ets(46:15)", "entry");
                    Image.width(10);
