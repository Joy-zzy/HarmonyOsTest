...
class Index2_2024_11_13 extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(22:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create();
            TextInput.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(23:7)", "entry");
        }, TextInput);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('获取当前窗口的属性');
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(24:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(28:7)", "entry");
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(34:7)", "entry");
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(38:7)", "entry");
            Button.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/learn/Index2_2024_11_13.ets(42:7)", "entry");
            Button.onClick(async () => {
