...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-11/Index.ets(13:5)", "entry");
            Column.height('100%');
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("mes:" + this.mes);
            Text.debugLine("entry/src/main/ets/pages/2024-11-11/Index.ets(14:7)", "entry");
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel("点击存储");
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/Index.ets(15:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/Index.ets(20:7)", "entry");
            Button.onClick(async () => {
                AlertDialog.show({
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-11/Index.ets(26:7)", "entry");
            Button.onClick(() => {
                router.pushUrl({
                    url: "pages/About"
                });
