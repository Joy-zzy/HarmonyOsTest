...
class NewWinPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/2024-11-13/NewWinPage.ets(13:5)", "entry");
            Column.width('100%');
            Column.height("100%");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/2024-11-13/NewWinPage.ets(15:7)", "entry");
